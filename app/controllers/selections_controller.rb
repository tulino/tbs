class SelectionsController < ApplicationController
  ...
  private
    ...
    def selection_params
      params.require(:selection).permit(:start_list_creation_date, :end_list_creation_date, :allow_list_creation, :start_selection_date, :end_selection_date, :allow_selection, :club_id)
    end
end
